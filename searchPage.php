...
<div class="main-elements">
    ...
    <main>
        ...
        <h2 class="title">Search Page (In all tasks)</h2>
        ...
        <div class="search-container">
            ...
            <select name="search" id="filter">
                ...
                <option value="5">Assigned by</option>
        ...
        <div class="table-container">
            ...
            <table id="searchTable">
                ...
                <tbody>
                <?php
                //select all tasks for the current user and due date is today
                $user_id = $_SESSION['id'];
                $query = "SELECT * FROM tasks";
                $res = $conn->query($query);

                //check if there are any tasks (using pdo)
                    ...
                    while ($row = $res->fetch()) {
                        ...
                        <tr>
                            ...
                            <td class="person-data">
                                ...
                                $sql2 = "SELECT * FROM members WHERE id = '$assigned_to'";
                                $res2 = $conn->query($sql2);
                                ...
                                echo "<img src='uploads/images/$toImage' alt='profile'>";
